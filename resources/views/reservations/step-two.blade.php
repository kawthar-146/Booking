                ...
                <div class="flex flex-col md:flex-row">
                    <div class="h-32 md:h-auto md:w-1/2">
                        <img class="object-cover w-full h-full"
                            src="https://st.depositphotos.com/1967477/2737/v/950/depositphotos_27377667-stock-illustration-chef-cartoon-with-blank-sign.jpg2" alt="img" />
                    </div>
                                    ...
                                    <div class="mt-1">
                                        <select id="team_id" name="team_id"
                                            ...
                                            @foreach ($team as $employee)
                                                <option value="{{ $employee->id }}" @selected($employee->id == $reservation->table_id)>
                                                    {{ $employee->name }}
                                                </option>
                                            @endforeach
                                        </select>
